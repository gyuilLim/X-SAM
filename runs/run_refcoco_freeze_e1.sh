...
CONFIG="xsam/configs/xsam/s3_refseg_clean_finetune/xsam_phi3_refcoco_freeze_e1.py"
WORK_DIR="${WORK_DIR:-${ROOT_DIR}/wkdrs/s3_refseg_clean_finetune/xsam_phi3_refcoco_freeze_e1}"
