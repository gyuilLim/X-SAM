...
train_datasets = dict(
    ...
    datasets=[refcoco_refseg_dataset],
)
...
evaluators = [
    dict(type=RefSegEvaluator, distributed=True, data_name="refcoco_val_refseg"),
    dict(type=RefSegEvaluator, distributed=True, data_name="refcoco_testA_refseg"),
    dict(type=RefSegEvaluator, distributed=True, data_name="refcoco_testB_refseg"),
]
