...
train_datasets = dict(
    ...
    datasets=[refcocog_refseg_dataset],
)
...
evaluators = [
    dict(type=RefSegEvaluator, distributed=True, data_name="refcocog_val_refseg"),
    dict(type=RefSegEvaluator, distributed=True, data_name="refcocog_test_refseg"),
]
