...
def main():
    ...
    # HuggingFace Trainer configs need FunctionType objects serialized through
    # MAP_FUNC. MMEngine configs can build callables directly; serializing them
    # here breaks nested `type=<function ...>` dataset configs.
